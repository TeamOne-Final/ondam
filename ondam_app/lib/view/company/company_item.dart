                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        await Get.dialog(
                          ...
                          AlertDialog(
                            titlePadding: EdgeInsets.fromLTRB(145, 30, 0, 0),
                            title: Text('메뉴추가', style: TextStyle(fontSize: 30,),),
                            content:
                          Padding(
                                ...
                                ElevatedButton(
                                  onPressed: () async{
                                    ...
                                    await Get.dialog(
                                      ...
                                      AlertDialog(
                                        titlePadding: EdgeInsets.fromLTRB(145, 30, 0, 0),
                                        title: Text('메뉴 수정', style: TextStyle(fontSize: 30,),),
                                        content:Padding(
                                        padding: const EdgeInsets.fromLTRB(20, 0, 20, 20),
                                        child: SizedBox(
                                          width: 300,
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ElevatedButton(
                                                onPressed: () {
                                                  controller.deleteItem(item['menuCode']);
                                                  controller.fetchItemList('%');
                                                }, 
