...
class SecondPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(
      ...
      centerTitle: false,
      title: Text('메뉴 월별 총 매출액',style: TextStyle(fontWeight: FontWeight.bold),),
    ...
    body: Obx(() {
      if(handler.monthMenu.isEmpty){
        return Center(child: Text('데이터를 불러오는 중입니다. \n 위의 카테고리를 선택하지 않았다면 위의 년도와 월을 선택해 주세요'));
      }
        return Center(
          child: SfCartesianChart(
            title: ChartTitle(
              text: '온담 제품 년/월별 총 매출 확인',
              textStyle: TextStyle(
            ...
            series: [
              BarSeries<Chart,String>(
                color: mainColor,
                name: "Menu Year & Month Prices",
                dataSource: handler.monthMenu,
                xValueMapper: (Chart menus, _) => menus.menuName,
            ...
            primaryXAxis: CategoryAxis(
              title: AxisTitle(text: '메뉴 명',textStyle: TextStyle(fontWeight: FontWeight.bold)),
            ),
