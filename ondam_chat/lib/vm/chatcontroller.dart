...
import 'package:ondam_chat/model/chatroom.dart';
import 'package:ondam_chat/vm/tablecontroller.dart';

class Chatcontroller extends Tablecontroller{
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  RxList<Chatroom> chatroom = <Chatroom>[].obs; 
  RxString rId= "".obs;

  Future<void>creatRoom(String tableId, String mytable, String table)async{
  try{
